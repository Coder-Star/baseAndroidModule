...
package com.coderstar.basemodule.wheelview.widget.views;
...
import com.coderstar.basemodule.wheelview.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int getDesiredHeight(LinearLayout layout) {
        ...
        Log.d (TAG,"desired = " + desired);
        Log.d (TAG,"getSuggestedMinimumHeight() = " + getSuggestedMinimumHeight());
	...
	private int getItemHeight() {
        ...
        Log.d (TAG,"getHeight() / visibleItems = " + (getHeight() / visibleItems));
